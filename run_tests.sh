...
run_test() {
    ...
    case "$file" in
        ...
        tests/new_tests/invalid_return_type_real_to_bool.i|\
        tests/new_tests/invalid_return_type_in_procedure.i|\
        tests/new_tests/invalid_return_missing_value.i|\
        tests/new_tests/invalid_return_outside_routine.i|\
