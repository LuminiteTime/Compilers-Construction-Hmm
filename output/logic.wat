(module
  ...
  (func $main (export "main") (result i32)
    ...
    (local $f i32)
    (local $or_result i32)
    (local $not_result i32)
    (local $and_result i32)
    (i32.const 1)
    (local.set $t)
    (i32.const 0)
    (local.set $f)
    ...
    (local.get $f)
    (i32.eqz)
    (local.set $not_result)
    (local.get $and_result)
    (call $print_int)
    (local.get $or_result)
    (call $print_int)
    (local.get $not_result)
    (call $print_int)
    (local.get $not_result)
  )
  (func $print_int (param $val i32)
    (i32.store8 (i32.const 1024) (i32.const 49))
    (i32.store8 (i32.const 1025) (i32.const 10))
    (i32.store (i32.const 2048) (i32.const 1024))
    (i32.store (i32.const 2052) (i32.const 2))
    (call $fd_write (i32.const 1) (i32.const 2048) (i32.const 1) (i32.const 0))
    (drop)
  )
