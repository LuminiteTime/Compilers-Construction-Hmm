(module
  ...
  (func $_start
    ;; Local variables
    (local $int_inferred i32)
    (local $real_inferred f64)
    (local $bool_inferred i32)
    (local $sum_inferred i32)
    (local $comparison_inferred i32)
    (local $logical_inferred i32)
    (i32.const 100)
    (local.set $int_inferred)
    (f64.const 2.71828)
    (local.set $real_inferred)
    (i32.const 0)
    (local.set $bool_inferred)
    (i32.const 30)
    (local.set $sum_inferred)
    (i32.const 1)
    (local.set $comparison_inferred)
    (i32.const 0)
    (local.set $logical_inferred)
    (local.get $int_inferred)
    (call $print_int)
    (i32.const 10)
    (call $print_char)
    (local.get $real_inferred)
    (call $print_real)
    (i32.const 10)
    (call $print_char)
    (local.get $bool_inferred)
    (call $print_int)
    (i32.const 10)
    (call $print_char)
    (local.get $sum_inferred)
    (call $print_int)
    (i32.const 10)
    (call $print_char)
    (local.get $comparison_inferred)
    (call $print_int)
    (i32.const 10)
    (call $print_char)
    (local.get $logical_inferred)
    (call $print_int)
    (i32.const 10)
    (call $print_char)
    (i32.const 0)
